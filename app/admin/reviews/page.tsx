    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="pt-28 pb-16 px-4 md:px-8 max-w-5xl mx-auto">
        ...
        <p className="text-sm text-muted mb-8">
          4–5 star reviews are auto-approved and shown publicly. 1–3 star reviews are private — only you can see them here.
        </p>
        ...
        <div className="grid grid-cols-3 gap-4 mb-10">
          ...
          <div className="rounded-xl border border-green-200 bg-green-50 p-4 text-center">
            ...
            <p className="text-xs text-green-600 mt-1">Public (4–5 ★)</p>
          </div>
                ...
                <div key={r.id} className="rounded-xl border border-red-200 bg-red-50 p-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      {r.website && <a href={r.website} target="_blank" rel="noopener noreferrer" className="text-xs text-accent underline">{r.website}</a>}
                    </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="font-semibold text-green-700">Public Reviews (4–5 stars)</h2>
          </div>
          {published.length === 0 ? (
