  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-4 pt-28 pb-20">
        ...
        <p className="text-sm text-muted mb-10">Last updated: May 19, 2026</p>

        <div className="flex flex-col gap-8 text-foreground-dim leading-relaxed text-sm">
          {[
            { title: '1. Service', body: 'MyGeoRadar provides AI visibility scan reports for businesses. Each scan is a one-time purchase of $29.99 USD. Reports simulate how AI engines may respond to queries about your business and are provided for informational purposes.' },
            ...
            { title: '6. Limitation of liability', body: 'MyGeoRadar is provided "as is." We are not liable for any business decisions made based on scan reports. Our total liability for any claim is limited to the amount paid for the scan in question ($29.99).' },
