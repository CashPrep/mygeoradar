...
const POST_META: Record<string, { title: string; tag: string }> = {
  ...
  'geo-before-launch':    { title: 'GEO Before Launch: Build AI Visibility Before You Open', tag: 'Strategy' },
  'ai-hallucination-fix': { title: 'When AI Gets Your Business Wrong: How to Fix AI Hallucinations', tag: 'Technical GEO' },
  'multi-location-geo':   { title: 'Multi-Location GEO: How Chains and Franchises Handle AI Visibility', tag: 'Local GEO' },
}
