          ...
          <div className="bg-surface border border-border rounded-2xl overflow-hidden">
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 p-8 md:p-10 flex flex-col gap-5">
                ...
                <p className="text-foreground-dim leading-relaxed text-sm">
                  I&apos;m a self-taught developer and entrepreneur studying at Elon University as an{' '}
                  <strong className="text-foreground">Artificial Intelligence Scholar</strong> &mdash; one of a select group of students chosen for deep study at the intersection of AI, ethics, and real-world application.
                </p>
