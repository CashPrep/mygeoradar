  ...
  return (
    <section className="px-4 md:px-8 pb-20">
      <div className="max-w-4xl mx-auto">
        <div className="relative overflow-hidden rounded-2xl bg-surface border border-border p-10 md:p-14 text-center flex flex-col items-center gap-6">
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div>
              ...
              <p className="mt-4 text-foreground-dim max-w-lg mx-auto">
