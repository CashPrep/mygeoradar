  ...
  return (
    <section id="how-it-works" className="section">
      <div className="text-center mb-10 md:mb-14">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight">Three steps. Under 60 seconds.</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 relative">
        ...
        {steps.map((step, i) => {
          ...
          return (
            <div key={i} className="relative z-10 flex flex-row md:flex-col items-start md:items-center text-left md:text-center gap-4 md:gap-5 p-5 md:p-6 rounded-2xl bg-surface border border-border hover:border-accent/40 transition-colors">
              <div className="relative shrink-0">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center">
              ...
              <div>
                <h3 className="font-bold text-foreground mb-1 md:mb-2 text-base md:text-lg">{step.title}</h3>
