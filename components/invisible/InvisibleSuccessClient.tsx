      ...
      code: `<script type="application/ld+json">
{
  ...
  },
  {
    ...
    actions: [
      ...
      '6. Yellow Pages — yp.com/claim',
      '7. BBB — bbb.org/get-accredited (free listing, paid accreditation optional)',
      '8. Angi / HomeAdvisor (if home services) — angi.com/pro-registration',
...
A: [2–3 sentence answer]`,
  ...
  },
  {
    ...
    template: {
      label: 'Press pitch email template',
      code: `Subject: Story idea: [Local angle about your business]
      ...
      code: `<script type="application/ld+json">
{
  ...
  },
  {
    ...
    actions: [
      ...
      'Add these statements (click "+ add statement" for each):',
...
"residential roofing contractor based in Denver, Colorado"`,
  ...
  },
  {
    ...
    actions: [
      ...
      '',
      '── WEEK 2: Content ──',
      'Day 8–9: Rewrite your About page using the formula in Step 4.',
      'Day 10–11: Create your /facts page using the template in Step 5.',
      'Day 12–14: Submit both pages to Google Search Console and Bing Webmaster Tools for indexing.',
      '',
      '── WEEK 3: Authority ──',
      'Day 15–16: Set up Bing Webmaster Tools and run your first site scan (Step 8). Fix critical issues.',
      'Day 17–18: Build your FAQ page with 10+ questions and add FAQPage schema (Step 7).',
      'Day 19–21: Send press pitch emails to your 5 targets (Step 6). Follow up after 5 days.',
      '',
      '── WEEK 4: Knowledge Graph ──',
      'Day 22–23: Create your Wikidata entry (Step 9).',
      'Day 24–25: If no press coverage yet, submit an EIN Presswire release.',
    ...
    tip: 'Don\'t skip ahead. Step 1 (GBP) makes Step 3 (directories) more effective. Step 4 (About page) makes Step 6 (press coverage) more impactful. The order matters.',
  },
]
      ...
      <section className="border-b border-border bg-surface">
        <div className="max-w-2xl mx-auto px-4 py-10 flex flex-col gap-5">
          ...
          <p className="text-sm text-foreground-dim leading-relaxed">
            Below is your complete 10-step action plan to get <strong className="text-foreground">{businessName}</strong> recognised
